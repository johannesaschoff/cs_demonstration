...
def render():
    ...
    st.write(''':blue-background[Food] :blue-background[Medicine] :blue-background[Water Pumps]''')
    ...
    try:
        ...
        charity_df = charity_df[charity_df["Focus"] == "Emergency Relief and Basic Needs"]   
